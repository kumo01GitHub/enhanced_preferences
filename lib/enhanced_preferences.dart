...
class EnhancedPreferences {
  ...
  Future<String?> getString(String key, [EnhancedPreferencesOptions? options]) {
    ...
    if (opts.enableCache && _cache.containsKey(key)) {
      ...
      return EnhancedPreferencesPlatform.instance.getString(key).then((
        String? value,
      ) {
        if (opts.enableCache) {
          _cache[key] = value;
  ...
  Future<String?> setString(
    ...
    return EnhancedPreferencesPlatform.instance.setString(key, value).then((
      String? key,
    ) {
  ...
  Future<int?> getInt(String key, [EnhancedPreferencesOptions? options]) {
    ...
    if (opts.enableCache && _cache.containsKey(key)) {
      ...
      return EnhancedPreferencesPlatform.instance.getInt(key).then((
        int? value,
      ) {
        if (opts.enableCache) {
          _cache[key] = value;
  ...
  Future<String?> setInt(
    ...
    return EnhancedPreferencesPlatform.instance.setInt(key, value).then((
      String? key,
    ) {
      if (opts.enableCache && key != null) {
        _cache[key] = value;
  ...
  Future<double?> getDouble(String key, [EnhancedPreferencesOptions? options]) {
    ...
    if (opts.enableCache && _cache.containsKey(key)) {
      ...
      return EnhancedPreferencesPlatform.instance.getDouble(key).then((
        double? value,
      ) {
        if (opts.enableCache) {
          _cache[key] = value;
  ...
  Future<String?> setDouble(
    ...
    return EnhancedPreferencesPlatform.instance.setDouble(key, value).then((
      String? key,
    ) {
      if (opts.enableCache && key != null) {
        _cache[key] = value;
  ...
  Future<bool?> getBool(String key, [EnhancedPreferencesOptions? options]) {
    ...
    if (opts.enableCache && _cache.containsKey(key)) {
      ...
      return EnhancedPreferencesPlatform.instance.getBool(key).then((
        bool? value,
      ) {
        if (opts.enableCache) {
          _cache[key] = value;
  ...
  Future<String?> setBool(
    ...
    return EnhancedPreferencesPlatform.instance.setBool(key, value).then((
      String? key,
    ) {
      if (opts.enableCache && key != null) {
        _cache[key] = value;
